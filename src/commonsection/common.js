      ...
      <nav className="navbar navbar-expand-lg navbar-light top-nav-bar">
        <div className="container-fluid">
          <Link className="navbar-brand " to="/">
            <div className="row w-100 px-10 py-6">
              <div>
                <img
                  src={logo}
                  alt="Portfolio Logo"
          ...
          >
            <div className="navbar-nav fw-bold">
              ...
              {!isAdminAuthenticated() && (
                <Link className={focusedNavBarClass("/extras")} to="/extras">
                  Music
                </Link>
              )}
            </div>
...
const ConnectWithMe = () => (
  ...
  >
    <div className="social-media-container" rel="noreferrer">
      <a
        href="https://www.facebook.com/iamkabishb"
        target="_blank"
      ...
      <a
        href="https://www.instagram.com/iamkabishb/"
        target="_blank"
        className="social-media-container-item mb-5"
        rel="noreferrer"
      >
      ...
      <a
        href="https://www.linkedin.com/in/kabish-bhattarai-9ab669190/"
        target="_blank"
        className="social-media-container-item mb-5"
        rel="noreferrer"
      >
      ...
      <a
        href="https://github.com/kabishbrt"
        target="_blank"
        className="social-media-container-item mb-5"
        rel="noreferrer"
      >
...
const socialMediaInformation = [
  {
    ...
    link:"https://www.youtube.com/channel/UCA_oIWOFu3x7LywkNdEa0vQ",
    color: "red",
  },

  {
    icon: "fab fa-github fa-2x",
    link: "https://github.com/Kabishbrt",
    color: "#1d1a1a",
  },
  {
    icon: "fab fa-linkedin-in fa-2x",
    link: "https://www.linkedin.com/in/kabish-bhattarai-9ab669190/",
    color: "#2867B2",
  },

  {
    icon: "fab fa-facebook-f fa-2x",
    link: "https://www.facebook.com/iamkabishb/",
    color: "#3b5998",
  },
  {
    icon: "fab fa-instagram fa-2x",
    link: "https://www.instagram.com/iamkabishb/",
    color: "#e4405f",
  },

  {
    icon: "fab fa-twitter fa-2x",
    link: "https://twitter.com/iamkabishb",
    color: "#1da1f2",
  },
];
    ...
    <div className="container py-5 px-4">
      <div className="row">
        <div className="col-lg-8">
          ...
          <a
            className="email"
            href="https://mail.google.com/mail/?view=cm&fs=1&to=kabishbrt@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
          kabishbrt@gmail.com
          ...
          <div className="copy fw-bold mt-5">
            ...
            <a href="https://kabishbhattarai.com.np/">Kabish Bhattarai</a>
          </div>
        </div>
      </div>
    </div>
